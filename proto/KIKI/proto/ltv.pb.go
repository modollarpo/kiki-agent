...
const file_ltv_proto_rawDesc = "" +
	...
	"\x10engagement_score\x18\x03 \x01(\x01R\x0fengagementScore\"]\n" +
	"\vLTVResponse\x12#\n" +
	"\rpredicted_ltv\x18\x01 \x01(\x01R\fpredictedLtv\x12)\n" +
	"\x10confidence_score\x18\x02 \x01(\x01R\x0fconfidenceScore2=\n" +
	"\n" +
	"LTVService\x12/\n" +
	"\n" +
	"PredictLTV\x12\x0f.ltv.LTVRequest\x1a\x10.ltv.LTVResponseB\fZ\n" +
	"KIKI/protob\x06proto3"
